...
string Polynomial::CleanString(const string& input)
{
    string cleaned;
    for (char ch : input)
    {
...
void Polynomial::ParseFromString(const string& inputRaw)
{
...
void Polynomial::LoadFromFile(const string& filename)
{
...
void Polynomial::AppendToFile(const string& filename) const
{
